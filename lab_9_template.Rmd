...
# b. Model summary:
summary(homes_lm1)
# list of coefficients is the model equation, but this is a problem: If everything is held constant, if you increase the number of bedrooms by 1, the price of a house would decrease by $30 792. Since you know that this is impossible, the model probably doesn't work great.
```
